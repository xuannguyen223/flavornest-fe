		...
		<div className="flex items-center gap-2 sm:gap-3 p-2 min-w-0">
			...
			<div className="flex flex-col sm:flex-row gap-2 sm:gap-3 flex-1 min-w-0">
				<FormInput
					...
					inputClassName="w-20 lg:w-24 xl:w-[134px] h-8 sm:h-8 lg:h-10 xl:h-14 placeholder:text-(--light-gray-color) text-(--primary-color) text-xs sm:text-sm lg:text-base xl:text-lg border-1 border-solid border-(--border-color) rounded-[10px]"
				/>
				...
				<FormSelect
					...
					className="flex-shrink-0"
					selectClassName="h-8 sm:h-8 lg:h-10 xl:h-14 w-32 lg:w-40 xl:w-[200px] rounded-[5px] px-4 text-xs sm:text-sm lg:text-base xl:text-lg"
				/>
				...
				<FormInput
					...
					inputClassName="w-full h-8 sm:h-8 lg:h-10 xl:h-14 placeholder:text-(--light-gray-color) text-(--primary-color) text-xs sm:text-sm lg:text-base xl:text-lg border-1 border-solid border-(--border-color) rounded-[10px]"
				/>
			</div>
